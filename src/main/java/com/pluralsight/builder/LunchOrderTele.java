...
/**
 * Problem 2 : Telescopping Constructors
 * Here we have to create constructors for various combination as per requirement
 * This is tidious to remember and also confusing due to multiple constructors
 */
